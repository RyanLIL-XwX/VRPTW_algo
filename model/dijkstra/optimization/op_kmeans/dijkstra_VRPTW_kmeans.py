...
from shapely.geometry import LineString # # 用于自交叉检查, 用于计算两个线段之间的交叉
...
class VRPTW_model(object):
    def __init__(self, file_path):
        ...
        self.location_collect_split_kmeans = list() # 储存层次聚类分类器的地址信息
    ...
    def plot_route_on_map(self, location_collect, shortest_path, file_name):
        ...
        route_map.save("{}_dij_VRPTW_kmeans.html".format(file_name))
...
if __name__ == "__main__":
    ...
    def start_find_path():
        ...
        # 将路径绘制到地图上
        order_data.plot_route_on_map(location_collect, optimized_final_path, file)
